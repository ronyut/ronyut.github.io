...
All findings were responsibly disclosed to the Israeli Cyber Emergency Response Team (CERT).

---

{{< alert icon="fire" cardColor="#e2131391" iconColor="#f1faee" >}}
...
- **Verification (Jan 2026)**: Price manipulation vulnerability remains exploitable
{{< /alert >}}
...
#### January 2026 Verification: Backend Price Persistence

During follow-up testing in January 2026, the backend was confirmed to still accept and persist attacker-controlled pricing values.
...
- **July 18, 2024** – Report submitted to Israeli CERT
- **September 2024** – Platform claimed remediation
- **January 2026** – Price manipulation still exploitable
...
The continued exploitability of price manipulation over a year after disclosure highlights the gap between remediation claims and actual security posture.
