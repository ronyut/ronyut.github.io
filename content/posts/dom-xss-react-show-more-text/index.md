...
👉 [How a Zero-Day in a React Library Exposed Corporate Data, Employee Credentials, and Financial Assets]({{< relref "react-supply-chain-xss-worm" >}})
...
4. **Final Render:** Entities decoded → `<img>` parsed → JavaScript executed
